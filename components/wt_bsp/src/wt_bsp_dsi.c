...
static const st7102_lcd_init_cmd_t s_st7102_vendor_specific_init[] = {
    {0x28, (uint8_t []){0x00}, 0, 0}, {0x10, (uint8_t []){0x00}, 0, 0},
    {0x99, (uint8_t []){0x71,0x02,0xa2}, 3, 0}, {0x99, (uint8_t []){0x71,0x02,0xa3}, 3, 0}, {0x99, (uint8_t []){0x71,0x02,0xa4}, 3, 0},
    {0xA4, (uint8_t []){0x31}, 1, 0}, {0xB0, (uint8_t []){0x22,0x43,0x1E,0x43,0x2F,0x57,0x57}, 7, 0},
    {0xB7, (uint8_t []){0x7D,0x7D}, 2, 0}, {0xBF, (uint8_t []){0x7A,0x7A}, 2, 0},
    ...
    {0xAD, (uint8_t []){0xCC,0x40,0x46,0x11,0x04,0x6F,0x6F}, 7, 0}, {0xE8, (uint8_t []){0x30,0x07,0x00,0xB3,0xB3,0x9C,0x00,0xE2,0x04,0x00,0x00,0x00,0x00,0xEF}, 14, 0},
    {0x75, (uint8_t []){0x03,0x04}, 2, 0}, {0xE7, (uint8_t []){0x8B,0x3C,0x00,0x0C,0xF0,0x5D,0x00,0x5D,0x00,0x5D,0x00,0x5D,0x00,0xFF,0x00,0x08,0x7B,0x00,0x00,0xC8,0x6A,0x5A,0x08,0x1A,0x3C,0x00,0x71,0x01,0x8C,0x01,0x7F,0xF0,0x22}, 33, 0},
    {0xE9, (uint8_t []){0x3C,0x7F,0x08,0x0D,0x1A,0x7A,0x22,0x1A,0x33}, 9, 0}, {0x99, (uint8_t []){0x71,0x02,0x00}, 3, 0},
    {0x11, (uint8_t []){0x00}, 0, 120}, {0x29, (uint8_t []){0x00}, 0, 20}, {0x35, (uint8_t []){0x00}, 1, 0}, {0x36, (uint8_t []){0x00}, 1, 0},
};
