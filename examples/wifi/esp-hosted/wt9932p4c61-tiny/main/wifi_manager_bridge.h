...
typedef struct {
    ...
    bool show_ota_config;
    bool show_sleep_config;
...
size_t wifi_manager_get_saved_credentials_count(void);
int wifi_manager_get_rssi(void);
int wifi_manager_get_channel(void);
void wifi_manager_get_ssid(char *buffer, size_t buffer_size);
void wifi_manager_get_ip_address(char *buffer, size_t buffer_size);
